...
\Juvix{} team for reporting bugs, providing feedback, and overall improving of the \VampIR{} repository, particularly Paul Cadman on adding compile, proof and verify APIs for the Halo2 backend so that \VampIR{} coul be used from Taiga as a library.
